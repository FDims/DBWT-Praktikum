...
<main>
    ...
    <table id="menu">
        ...
        <tr>
            <td class="menulist">Rindfleisch mit Bambus, Kaiserschoten und rotem Paprika, dazu Mie Nudeln</td>
            <td class="menulist">3,50</td>
            <td class="menulist">6,20</td>
        </tr>
        <tr>
            <td class="menulist">Spinatrisotto mit kleinen Samosateigecken und gemischter salat</td>
            <td class="menulist">2,90</td>
            <td class="menulist">5,30</td>
        </tr>
        <tr>
            <th class="menulist">...</th>
            <th class="menulist">...</th>
